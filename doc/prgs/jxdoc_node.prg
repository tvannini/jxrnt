...
o2def::view("sections", False, "", "", 1);
o2def::view("key_words", False, "", "", 1);
o2def::view("links", False, "", "", 1);
o2def::view("sections_order", False, "", "", 1);
o2def::view("ancestors", False, "", "", 1);
o2def::view("app_links", False, "", "", 1);
o2def::view("program_node", False, "", "", 1);
o2def::view("form_node", False, "", "", 1);
o2def::act("close_all");
