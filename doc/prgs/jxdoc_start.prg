...
o2def::view("nodes", False, "", "", 1);
o2def::view("sub_nodes", False, "", "", 1);
o2def::view("app_links_ctrl", False, "", "", 1);
o2def::view("app_links_form", False, "", "", 1);
o2def::view("app_link_prg", False, "", "", 1);
o2def::view("nodes_id", False, "", "", 1);
o2def::view("container", False, "", "", 1);
o2def::view("p_container", False, "", "", 1);
o2def::view("prg_forms", False, "", "", 1);
o2def::act("add_all");
